...
| M6g one-step robot response | Implemented candidate; verification per source | Exact adjacent recorded action/state transition; predictor supervision separate from detached P3 innovation. Not object contact or progress. |
