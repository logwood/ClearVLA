...
OUT_DIR=${OUT_DIR:-runs/v40_1_k6a6_statecf1_residual_v37_actionflow_smoke_b8_10}
...
python -u -m clearvla.cli.train_v40_policy \
  ...
  --final-action-decoder residual_action_flow \
  --action-flow-residual-depth 2 \
  --action-flow-residual-high-slots 4 \
  --action-flow-residual-max-scale 0.20 \
