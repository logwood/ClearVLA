...
OUT_DIR=${OUT_DIR:-runs/v42_latent_cvae_action_smoke_b8_20}
...
python -u -m clearvla.cli.train_v40_policy \
  ...
  --lr 8e-5 \
  --proposal-lr 5e-5 \
  --latent-action-decoder-lr-scale 1.0 \
  --latent-cvae-action-decoder-lr-scale 1.0 \
  --latent-cvae-kl-weight 5e-4 \
  --latent-cvae-posterior-recon-weight 0.25 \
  --weight-decay 0.01 \
  --beta1 0.9 \
  --beta2 0.999 \
  --eps 1e-8 \
