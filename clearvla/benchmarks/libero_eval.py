...
def validate_libero_bridge_health(
    ...
    *,
    ...
    the two-camera ordering, direct relative-command arm mode and continuous
    ...
    if str(action.get("arm_flow_mode", "")) != "relative_command_direct":
        raise ValueError(
            "LIBERO evaluation requires direct relative-command arms"
        )
