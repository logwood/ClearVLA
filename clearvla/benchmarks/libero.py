    ...
    *,
    ...
    def writer(temporary: Path) -> None:
        with h5py.File(temporary, "w") as stream:
            ...
            # The current shared codec still exposes the direct relative
            # command mode.  Keep the benchmark outlet declaration aligned
            # with that active ABI; the future semantic adapter rename is a
            # separate migration and must not be implied by conversion.
            stream.attrs["arm_flow_mode"] = "relative_command_direct"
