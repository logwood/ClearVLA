    ...
    if bool(getattr(planner, "object_intent_dynamics_mainline", False)):
        ...
        losses["grad_object_w_inputs"] = _parameter_grad_norm(
            (
                ...
                *world.condition_object.parameters(),
                *world.condition_interaction.parameters(),
                *world.state_object_interaction.parameters(),
                *world.interval_object_identity.parameters(),
                *world.decoder_object_identity.parameters(),
                *world.camera_geometry.parameters(),
        ...
        losses["grad_object_p3_precision"] = _parameter_grad_norm(
            (
                ...
                *p3.precision_consequence_query.parameters(),
                *p3.precision_object_key.parameters(),
                *p3.precision_object_value.parameters(),
