...
class ComponentABI:
    ...
    top: str = "conditional_k_public_private_grounding_zero_centered_intent_single_typed_ingress_w_per_type_p2_consequence_p3"
    ...
    training: str = "v120_mirrored_physical_flow_observed_current_grounding_shared_w_field_targets_exact_teacher_event_boost_v120_decay_three_owner_clip"
