...
class ComponentABI:
    ...
    top: str = "v120_progressive_g123_dense_grounder_fp32_support_logs_exact_p1_s_owned_k_typed_relevance_four_interval_w_stage_private_p2_transport_conditioned_semantic_address_physical_value_typed_consequence_plus_two_optional_p3"
    ...
    training: str = "v120_mirrored_physical_flow_exact_teacher_current_support_raw_transport_continuous_post_event_gripper_trajectory_v120_decay_local_global_clip_source_gradient_probes"
    runtime: str = "cached_observation_progressive_gsw_exact_p1_v120_nodes_clean_endpoint_decoded_gripper_events_teacher_isolated_finite_spike_matched_p2_value_address_metrics"
