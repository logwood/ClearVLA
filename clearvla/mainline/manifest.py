...
class ComponentABI:
    ...
    top: str = "v120_cumulative_intent_four_interval_dynamics_protected_candidate_p1_five_lane_p3"
    ...
    runtime: str = "cached_observation_gsw_p1_detail_dynamic_p1_per_ode_transition_teacher_isolated"
