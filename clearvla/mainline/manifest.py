...
class ComponentABI:
    ...
    top: str = "canonical_decoded_k_content_stateless_state_supervision_w_owned_common_residual_typed_base_interaction_camera_mixture_p2_consequence_p3"
