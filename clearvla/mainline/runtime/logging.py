        ...
        *,
        ...
        groups: tuple[tuple[str, tuple[str, ...]], ...] = (
            ...
            (
                ...
                (
                    "loss_flow_warp",
                    "loss_flow_feature_warp",
                    "loss_flow_feature_zero_warp",
                    "loss_flow_photometric_warp",
                    "loss_flow_photometric_zero_warp",
                    "loss_flow_identity_advantage",
                    "loss_flow_static_identity",
                    "loss_flow_cycle",
                    "loss_flow_smoothness",
                    "loss_flow_uncertainty",
                    "loss_flow_refinement_sequence",
            ...
            (
                ...
                (
                    ...
                    "object_grounding_dense_objective_count",
                    "object_grounding_existence_mean",
                    "object_grounding_validity_mean",
                    "object_grounding_allocation_share_mean",
                    "object_grounding_null_mass",
                    "object_grounding_mass_conservation_error",
                    "object_grounding_candidate_owner_entropy",
                    "object_grounding_local_prior_entropy",
                    "object_grounding_chart_entropy",
                    ...
                    "object_grounding_transport_prior_rms",
                    ...
                    "object_intent_state_change_history_rms",
                    "object_intent_state_change_transport_rms",
                    ...
                    "object_w_goal_innovation_rms",
                    "object_w_typed_common_input_rms",
                    "object_w_typed_interval_input_rms",
                    "object_w_semantic_common_contribution_rms",
                    "object_w_semantic_interval_contribution_rms",
                    "object_w_semantic_common_input_relevance_mass",
                    "object_w_semantic_interval_input_relevance_mass",
                    "object_w_appearance_common_contribution_rms",
                    "object_w_appearance_interval_contribution_rms",
                    "object_w_appearance_common_input_relevance_mass",
                    "object_w_appearance_interval_input_relevance_mass",
                    "object_w_geometry_common_contribution_rms",
                    "object_w_geometry_interval_contribution_rms",
                    "object_w_geometry_common_input_relevance_mass",
                    "object_w_geometry_interval_input_relevance_mass",
                    "object_w_common_generic_condition_rms",
                    "object_w_near_condition_rms",
                    "object_w_far_condition_rms",
                    "object_w_typed_common_state_rms",
                    ...
                    "object_teacher_association_uncertainty",
                    ...
                    "object_teacher_semantic_max",
                    "object_teacher_semantic_margin",
                    "object_teacher_appearance_max",
                    "object_teacher_appearance_margin",
                    "object_teacher_geometry_margin",
                    "object_teacher_supports_per_interval",
                    "object_teacher_flow_horizon_scale_mean",
                    "object_teacher_flow_horizon_scale_max",
                    ...
                    "loss_future_transport_innovation",
                    "object_w2_interval_adjacent_cosine",
                    "object_w2_object_pair_cosine",
                    "loss_future_transition",
                    "p1_query_rows",
            ...
            (
                ...
                (
                    ...
                    "object_p3_consequence_innovation_rms",
                    "object_p3_temporal_private_rms",
                    "object_p3_temporal_rms",
                    "object_p3_temporal_contract_min",
                    "object_p3_state_change_rms",
                    "object_p3_state_change_contract_min",
                    "controlled_transition_source_rms",
                    "controlled_transition_source_spatial_variation",
                    "controlled_transition_source_anchor_variation",
                    "controlled_transition_value_rms",
                    "controlled_transition_basis_rms",
                    ...
                    "controlled_transition_retained_rows",
                    "controlled_transition_per_ode_action",
                    "controlled_transition_learned_neutral",
                    "controlled_transition_action_token_rows",
            ...
            (
                ...
                (
                    ...
                    "validation_proposal_ablation_batches",
        ...
        tensor_gradient_fields = [
            f"{name}={value:.6g}"
            for name, value in sorted(metrics.items())
            if name.startswith("gradient_tensor_")
        ]
        if tensor_gradient_fields:
            rows.append(
                " ".join(
                    (
                        f"[mainline-{kind}-grad-tensor]",
                        lead_suffix,
                        *tensor_gradient_fields,
                    )
                )
