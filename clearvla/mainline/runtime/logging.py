...
def archival_metrics(values: Mapping[str, float]) -> dict[str, float]:
    ...
    return {
        ...
        if name.startswith(ACTIVE_PREFIXES) or name == "learning_rate"
    }
...
def active_metrics(values: Mapping[str, float], *, zero_tolerance: float = 0.0) -> dict[str, float]:
    ...
    for name, value in archival_metrics(values).items():
        ...
        visible_zero = (
            ...
            or name.startswith("gradient_tensor_")
        ...
        groups: tuple[tuple[str, tuple[str, ...]], ...] = (
            ...
            (
                ...
                (
                    ...
                    "object_intent_semantic_common_object_variation",
                    ...
                    "object_intent_semantic_interval_residual_object_variation",
                    "object_intent_semantic_interval_residual_variation",
                    "object_intent_semantic_common_policy_context_rms",
                    "object_intent_semantic_interval_residual_policy_context_rms",
                    ...
                    "object_intent_appearance_common_object_variation",
                    ...
                    "object_intent_appearance_interval_residual_object_variation",
                    "object_intent_appearance_interval_residual_variation",
                    "object_intent_appearance_common_policy_context_rms",
                    "object_intent_appearance_interval_residual_policy_context_rms",
                    ...
                    "object_intent_geometry_common_object_variation",
                    ...
                    "object_intent_geometry_interval_residual_object_variation",
                    "object_intent_geometry_interval_residual_variation",
                    "object_intent_geometry_common_policy_context_rms",
                    "object_intent_geometry_interval_residual_policy_context_rms",
                    ...
                    "object_w_common_to_interval_interaction_rms",
                    "object_w_common_to_interval_denominator_min",
                    "object_w_appearance_semantic_common_modulation_rms",
                    "object_w_appearance_semantic_interval_modulation_rms",
                    "object_w_appearance_semantic_denominator_min",
                    "object_w_public_content_rms",
                    "object_w_object_innovation_rms",
                    "object_w_object_innovation_variation",
                    "object_w_semantic_common_contribution_rms",
                    "object_w_semantic_common_contribution_object_variation",
                    "object_w_semantic_residual_contribution_rms",
                    "object_w_semantic_residual_contribution_interval_variation",
                    "object_w_semantic_residual_contribution_object_variation",
                    "object_w_semantic_common_input_mass",
                    "object_w_semantic_residual_input_mass",
                    "object_w_semantic_common_input_value_rms",
                    "object_w_semantic_residual_input_value_rms",
                    "object_w_appearance_common_contribution_rms",
                    "object_w_appearance_common_contribution_object_variation",
                    "object_w_appearance_residual_contribution_rms",
                    "object_w_appearance_residual_contribution_interval_variation",
                    "object_w_appearance_residual_contribution_object_variation",
                    "object_w_appearance_common_input_mass",
                    "object_w_appearance_residual_input_mass",
                    "object_w_appearance_common_input_value_rms",
                    "object_w_appearance_residual_input_value_rms",
                    "object_w_geometry_common_contribution_rms",
                    "object_w_geometry_common_contribution_object_variation",
                    "object_w_geometry_residual_contribution_rms",
                    "object_w_geometry_residual_contribution_interval_variation",
                    "object_w_geometry_residual_contribution_object_variation",
                    "object_w_geometry_common_input_mass",
                    "object_w_geometry_residual_input_mass",
                    "object_w_geometry_common_input_value_rms",
                    "object_w_geometry_residual_input_value_rms",
            ...
            (
                ...
                (
                    ...
                    "p1_policy_updated_trajectory_rms",
                    "p1_factual_base_rms",
                    ...
                    "p1_policy_self_gate",
                    "p1_policy_self_raw_rms",
                    "p1_policy_self_proposed_rms",
                    "p1_policy_self_bounded_rms",
                    "p1_policy_self_written_rms",
                    "p1_policy_self_compression",
                    "p1_policy_ffn_gate",
                    "p1_policy_ffn_raw_rms",
                    "p1_policy_ffn_proposed_rms",
                    "p1_policy_ffn_bounded_rms",
                    "p1_policy_ffn_written_rms",
                    "p1_policy_ffn_compression",
                    "p1_policy_residual_raw_rms",
                    "p1_policy_residual_proposed_rms",
                    "p1_policy_residual_bounded_rms",
                    "p1_policy_residual_written_rms",
                    "p1_policy_residual_compression",
                    "p1_policy_normalization_denominator_min",
                    "p1_policy_normalization_gain_max",
                    "p1_policy_modulation_shift_max_abs",
                    "p1_policy_modulation_scale_max_abs",
                    "p1_policy_modulation_shift_raw_max_abs",
                    "p1_policy_modulation_scale_raw_max_abs",
                    "p1_policy_self_qk_rms",
                    "p1_policy_ffn_input_rms",
                    "object_p2_content_score_abs",
                    "object_p2_content_score_max_abs",
                    "object_p2_s_condition_only_score_abs",
                    ...
                    "object_p2_complete_field_joint_posterior_max",
                    "object_p2_complete_field_null_mass",
                    "object_p2_public_s_condition_only_score_abs",
                    "object_p2_public_s_condition_only_score_max_abs",
                    "object_p2_type_interval_score_abs",
                    "object_p2_type_interval_score_max_abs",
                    ...
                    "object_p2_type_interval_effective_count",
                    "object_p2_type_interval_horizon_variation",
                    "object_p2_semantic_public_s_condition_only_score_abs",
                    "object_p2_semantic_typed_s_condition_only_score_abs",
                    "object_p2_semantic_unconditioned_w_interval_score_abs",
                    "object_p2_semantic_interval_posterior_entropy",
                    "object_p2_semantic_interval_posterior_max",
                    "object_p2_geometry_public_s_condition_only_score_abs",
                    "object_p2_geometry_typed_s_condition_only_score_abs",
                    "object_p2_geometry_unconditioned_w_interval_score_abs",
                    "object_p2_geometry_interval_posterior_entropy",
                    "object_p2_geometry_interval_posterior_max",
                    ...
                    "object_p2_selected_complete_field_semantic_common_component_rms",
                    "object_p2_selected_complete_field_geometry_common_component_rms",
                    "object_p2_selected_complete_field_semantic_residual_component_rms",
                    "object_p2_selected_complete_field_geometry_residual_component_rms",
                    "object_p2_geometry_complete_field_collapsed_kc_posterior_entropy",
                    "object_p2_geometry_complete_field_collapsed_kc_posterior_max",
                    "object_p2_geometry_complete_field_joint_kc_posterior_entropy",
                    "object_p2_geometry_complete_field_joint_kc_posterior_max",
                    ...
                    "object_p2_semantic_selected_complete_field_common_rms",
                    "object_p2_geometry_selected_complete_field_common_rms",
                    "object_p2_semantic_selected_complete_field_residual_rms",
                    "object_p2_geometry_selected_complete_field_residual_rms",
                    "object_p2_semantic_complete_field_common_candidate_rms",
                    "object_p2_geometry_complete_field_common_candidate_rms",
                    "object_p2_semantic_complete_field_residual_candidate_rms",
                    "object_p2_geometry_complete_field_residual_candidate_rms",
                    "object_p2_semantic_complete_field_shared_contract_scale_mean",
                    "object_p2_geometry_complete_field_shared_contract_scale_mean",
                    "object_p2_complete_field_interval_0_mass",
                    "object_p2_complete_field_interval_1_mass",
                    "object_p2_complete_field_interval_2_mass",
                    "object_p2_complete_field_interval_3_mass",
                    "object_p2_semantic_complete_field_interval_0_mass",
                    "object_p2_semantic_complete_field_interval_1_mass",
                    "object_p2_semantic_complete_field_interval_2_mass",
                    "object_p2_semantic_complete_field_interval_3_mass",
                    "object_p2_geometry_complete_field_interval_0_mass",
                    "object_p2_geometry_complete_field_interval_1_mass",
                    "object_p2_geometry_complete_field_interval_2_mass",
                    "object_p2_geometry_complete_field_interval_3_mass",
