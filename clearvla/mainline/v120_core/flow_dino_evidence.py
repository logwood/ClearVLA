        ...
        return ProgressiveFineCandidates(
            ...
            metrics={
                ...
                "flow_jepa_progressive_g2_input_std_rms": (
                    normalized_std_base.detach().float().square().mean().sqrt()
                ),
    ...
    def update(
        ...
        *,
        ...
        if stage == 2:
            ...
            correction_scale = aligned_safe_std + self.address_variance_epsilon_norm
            correction_proposal = (
        ...
        if self.exports_grounded_facts:
            ...
            grounded_facts = GroundedFactSet(
                ...
                semantic_owner_probs=owner_slot_weights["semantic"],
                appearance_owner_probs=owner_slot_weights["appearance"],
                geometry_owner_probs=owner_slot_weights["geometry"],
            ...
            if intervention in _GROUNDED_G3_SLOT_INTERVENTIONS:
                ...
                semantic_owner_log = grounded_facts.semantic_owner_log_probs
                appearance_owner_log = grounded_facts.appearance_owner_log_probs
                geometry_owner_log = grounded_facts.geometry_owner_log_probs
                if (
                    semantic_owner_log is None
                    or appearance_owner_log is None
                    or geometry_owner_log is None
                ):
                    raise RuntimeError(
                        "grounded G3 intervention lost typed FP32 owner logs"
                    )
                owner_slot_log_weights = {
                    "semantic": semantic_owner_log,
                    "appearance": appearance_owner_log,
                    "geometry": geometry_owner_log,
                }
                metrics[
