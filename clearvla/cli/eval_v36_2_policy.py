...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate a V36.2 physical-action-flow policy checkpoint."
    )
...
def main() -> None:
    ...
    episodes, train_ids, val_ids, test_ids, _, _, image_store, _ = load_data(
        args,
        min_length=dataset_config.world_horizon
    ...
    report = {
        "schema": "clearvla-v36-2-policy-eval-v1",
        "split": args.split,
