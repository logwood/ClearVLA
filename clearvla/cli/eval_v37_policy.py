...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate V37 full-latent world-shaped policy.")
...
def main() -> None:
    ...
    if payload.get("schema") != "clearvla-v37-policy-checkpoint-v1":
        raise ValueError("--checkpoint must be a V37 policy checkpoint")
    ...
    class Geometry:
        ...
        num_future = int(source_world["num_future"])
