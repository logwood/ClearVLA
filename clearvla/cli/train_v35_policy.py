...
from clearvla.experiments.observed_state_lab.policy_runtime import (
...
def main() -> None:
    ...
    trainer = V35PolicyTrainerConfig(
        **{name: getattr(args, name) for name in V35PolicyTrainerConfig.__dataclass_fields__}
    )
    context = {
        "schema": "clearvla-v35-policy-context-v1",
        "args": vars(args),
