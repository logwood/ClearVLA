...
def main() -> None:
    require_legacy_rdt2_cli("clearvla/cli/eval_rdt2_grounded_motor.py")
    args = parse_args()
    ...
    model_config = GroundedMotorRDT2FMConfig(**context["model"])
    ...
    def run_one(ablation: str):
        return evaluate_grounded_motor_rdt2_fm(
            model,
            conditioner,
            loader,
            device=device,
    ...
    report = {
        "schema": "clearvla-rdt2-grounded-motor-eval-v1",
