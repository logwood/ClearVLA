...
from clearvla.experiments.observed_state_lab.gripper_event_table import (
    GripperTableConfig,
    collect_window_predictions_for_episode,
    write_gripper_tables,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dump event-centered gripper tables for one V36.2 val/test episode.")
    ...
    parser.add_argument("--target-event-rate-min", type=float, default=0.50)
...
def main() -> None:
    ...
    table_config = GripperTableConfig(
        ...
        target_event_rate_min=args.target_event_rate_min,
