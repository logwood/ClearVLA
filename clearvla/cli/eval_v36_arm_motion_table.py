...
from clearvla.experiments.observed_state_lab.policy_runtime_v36 import V36PolicyTrainerConfig
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dump arm-motion and optional FK task-space tables for one V36 episode.")
