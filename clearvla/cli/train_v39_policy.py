...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train V39 staged mid-cut latent-contract temporal policy.")
    ...
    parser.add_argument("--layer-contract-adapters", type=int, default=0, help="V39.1: enable tiny contract adapters after every DiT block.")
    ...
    parser.add_argument("--layer-shared-fm-probe", type=int, default=0, help="V39.2: use one shared flow-matching action probe after each layer latent head.")
    parser.add_argument("--layer-fm-probe-hidden", type=int, default=256)
    parser.add_argument("--layer-recurrent-consequence", type=int, default=0, help="V39.3: roll each layer latent through K action-conditioned consequence milestones.")
    ...
    parser.add_argument("--layer-state-counterfactual", type=int, default=0, help="Experimental non-strict state/frame shuffle diagnostic; disabled by default.")
